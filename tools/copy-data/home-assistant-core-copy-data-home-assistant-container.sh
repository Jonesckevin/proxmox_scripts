...
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/Jonesckevin/proxmox_scripts/mainmain/tools/copy-data//home-assistant-core-copy-data-home-assistant-container.sh)"
